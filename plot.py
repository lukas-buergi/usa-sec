...
for c in ['AECOM', 'AEROJET ROCKETDYNE HLDGS INC', 'BWX TECHNOLOGIES INC', 'FLUOR CORP NEW', 'HUNTINGTON INGALLS INDS INC', 'JACOBS SOLUTIONS INC', 'MOOG INC', 'TEXTRON INC']:
  df2['Andere'] = df2[c]
  del df2[c]

df2.plot(kind='area', colormap='Greys')
